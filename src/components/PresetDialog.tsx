...
// Dialog for saving current device setup as a new preset
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-3 justify-end">
            <button
              type="button"
              onClick={handleClose}
              className="px-4 py-2 bg-[#1E2939] hover:bg-[#2A3441] text-white rounded-lg transition-colors disabled:opacity-50 cursor-pointer"
              disabled={loading}
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors disabled:opacity-50 flex items-center gap-2 cursor-pointer"
